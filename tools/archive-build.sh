...
archive_path="dist/tasmota-esp32-libs-solo1-$idf_version_string.tar.gz"
build_archive_path="dist/tasmota-esp32-build-solo1-$idf_version_string.tar.gz"
pio_archive_path="dist/tasmota-arduinoespressif32-solo1-$idf_version_string.tar.gz"
echo "$archive_path"
...
if [ -d "out" ]; then
    ...
    git clone https://github.com/tasmota/arduino-esp32 -b release/v1.0
