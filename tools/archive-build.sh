...
archive_path="dist/arduino-esp32-libs-$idf_version_string-solo1.tar.gz"
build_archive_path="dist/arduino-esp32-build-$idf_version_string-solo1.tar.gz"
pio_archive_path="dist/framework-arduinoespressif32-$idf_version_string-solo1.tar.gz"
echo "$archive_path"
