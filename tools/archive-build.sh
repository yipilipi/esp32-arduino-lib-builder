...
idf_solo1_string=${idf_version_string%"-solo1"}
echo "$idf_solo1_string"
archive_path="dist/arduino-esp32-libs-$idf_solo1_string.tar.gz"
build_archive_path="dist/arduino-esp32-build-$idf_solo1_string.tar.gz"
pio_archive_path="dist/framework-arduinoespressif32-$idf_solo1_string.tar.gz"
echo "$archive_path%"
