...
archive_path="dist/tasmota-esp32-libs-$idf_version_string.tar.gz"
build_archive_path="dist/tasmota-esp32-build-$idf_version_string.tar.gz"
pio_archive_path="dist/tasmota-arduinoespressif32-$idf_version_string.tar.gz"
echo "$archive_path"
